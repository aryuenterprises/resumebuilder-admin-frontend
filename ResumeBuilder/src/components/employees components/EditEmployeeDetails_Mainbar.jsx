...
const CreateEmployee_Mainbar = () => {
  ...
  const [uploadedDocuments, setUploadedDocuments] = useState([
    {
      ...
      files: [
        {
          file: {
            path: "Abdul Rahman's Resume React Js Developer.pdf",
            relativePath: "Abdul Rahman's Resume React Js Developer.pdf",
          },
          id: 1737463242720.66,
          preview: resume,
        },
  ...
  return (
    <div className="w-screen flex flex-col justify-between min-h-screen bg-gray-100 px-3 pt-2 md:pt-5">
      <div>
        <Mobile_Sidebar />
        ...
        <div className="flex gap-2 mt-5 text-sm items-center">
          ...
          <p>{">"}</p>
          <p className=" text-blue-500 ">Edit Employee Details</p>
          <p>{">"}</p>
        </div>
          ...
          <div className="flex flex-col  lg:flex-row gap-3 my-5">
            ...
            <div className="basis-[50vw] flex-grow flex flex-col gap-3 ">
              <div className="rounded-2xl border-2 border-gray-200 bg-white  py-4 px-4 lg:px-6">
                ...
                <p id="personal-info" className="text-xl font-semibold">
                  Personal Info
                </p>
                        ...
                        <div className=" w-full">
                          <div className="flex justify-between">
                            ...
                            <p
                              ...
                              onClick={() => onClickDocumentDeleteButton(index)}
                            >
                              x
                            </p>
                          </div>
