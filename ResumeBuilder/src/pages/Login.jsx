  ...
  const onCLickLogin = async (e) => {
    ...
    try {
      ...
      if (response.data && response.data.token) {
        ...
        // Store user data and token
        localStorage.setItem("resumintAdmin", JSON.stringify(data.user));
      ...
      console.log("errrr",err.response?.data || err);
      setError(
  ...
  return (
    <div className="min-h-screen bg-[#F8F8FA]">
      <div className="flex  items-center justify-center ">
        <img src={logoPreview || resumemint_logo} alt="" className="w-64 h-15 mt-6" />
      ...
      <div className="flex items-center justify-center  ">
        <div className="lg:basis-[50%] flex flex-col items-center justify-center gap-3">
          <p className="text-[#C40116] font-semibold font text-2xl md:text-4xl">
          ADMIN LOGIN
          </p>
          ...
          <button
            ...
            className="font-semibold  mt-3  bg-gradient-to-r from-[#C40116]/50 to-[#C40116] px-8 py-3 rounded-full text-white hover:scale-105 duration-300"
          >
            Login Now
          </button>
          {/* </form> */}
